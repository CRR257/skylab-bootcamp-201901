function Cart (){
    this.products = []  /*creem llista buida de productes*/ 
}
...
Cart.prototype.add = function(product){  
    ...
    creem la funció add, pq es vagin afegint els elements a Cart.*/
    this.products.push(product)
}

/*podem buscar Cart.products i veurem array de productes o per producte, bra*/
