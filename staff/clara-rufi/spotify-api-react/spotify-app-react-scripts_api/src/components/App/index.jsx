...
class App extends Component {
    ...
    render() {
        ...
        return <main className="app">
            ...
            <Route path="/" render={() => logic.isUserLoggedIn ? <Home language={selectedLanguage} /> : <section className="logReg"><Link to="/login">Login</Link> ---- <Link to="/register">Register</Link></section>} />
        </main>
    }
}
